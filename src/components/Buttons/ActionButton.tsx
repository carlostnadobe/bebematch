...
export const ActionButton: React.FC<ActionButtonProps> = ({
  ...
  const config = (() => {
    switch (type) {
      case 'like':
        return {
          renderIcon: (color: string) => <BookmarkIcon size={18} color={color} />,
          label: 'Anotar nombre',
          bg: colors.salmon,
          border: colors.salmon,
          color: '#FFFFFF',
          isPill: true,
          accessibilityLabel: 'Anotar nombre en el cuaderno',
        };
      case 'dislike':
        return {
          ...
          color: colors.text,
          isPill: true,
          accessibilityLabel: 'Descartar página y pasar a la siguiente',
        };
      case 'undo':
        return {
          renderIcon: (color: string) => <RefreshIcon size={18} color={color} />,
          label: '',
          bg: colors.surface2,
          border: colors.border2,
          color: colors.text2,
          isPill: false,
          accessibilityLabel: 'Volver a la página anterior',
        };
    }
  })();
